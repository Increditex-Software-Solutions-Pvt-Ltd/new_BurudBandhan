    ...
    <div>
      <div className='relative mb-[80px]'>
        ...
        <div className='rounded-xl absolute top-20 left-0 right-0 m-auto bg-white w-fit p-5'>
          <img className='w-[150px] h-[150px] m-auto' src={burudLogo} alt='logo' />
          ...
          <button className='mt-6 bg-red-600 px-8 py-4 text-white rounded-full text-2xl font-semibold'>आजच फ्री नोंदणी करा </button>
        </div>
      </div>
